...
export type AdminVideoTranscodingCancelJobRequest = operations['admin___video-transcoding___cancel-job']['requestBody']['content']['application/json'];
export type AdminVideoTranscodingListJobsRequest = operations['admin___video-transcoding___list-jobs']['requestBody']['content']['application/json'];
export type AdminVideoTranscodingListJobsResponse = operations['admin___video-transcoding___list-jobs']['responses']['200']['content']['application/json'];
export type AdminVideoTranscodingRetryJobRequest = operations['admin___video-transcoding___retry-job']['requestBody']['content']['application/json'];
