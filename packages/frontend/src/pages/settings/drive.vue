						...
						<MkPreferenceContainer k="defaultImageCompressionLevel">
							<MkSelect
								v-model="defaultImageCompressionLevel" :items="[
									...
									{ label: `${i18n.ts.highest} (${i18n.ts._compression._quality.highest}; ${i18n.ts._compression._size.largest})`, value: 1 },
									{ label: `${i18n.ts.high} (${i18n.ts._compression._quality.high}; ${i18n.ts._compression._size.large})`, value: 2 },
									{ label: `${i18n.ts.medium} (${i18n.ts._compression._quality.medium}; ${i18n.ts._compression._size.medium})`, value: 3 },
									{ label: `${i18n.ts.low} (${i18n.ts._compression._quality.low}; ${i18n.ts._compression._size.small})`, value: 4 },
								]"
							>
