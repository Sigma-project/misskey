...
function playWhenAvailable() {
	...
	const watchStop = watch([mediaEl, active, hide], ([newMediaEl, isActive, isHidden]) => {
...
function onActive() {
	active.value = true;
	if (props.content.type === 'audio' && !hide.value) playWhenAvailable();
}
