...
| 6 | Security Guardrails | SPDX checker、migration 不変性ルール、locale 編集ルール (ja-JP / en-US 限定)、secrets 検出 |
...
Quality Gates:        7/10   (変更ファイル lint / `/quality-gate` あり、fork の全体 lint あり)
